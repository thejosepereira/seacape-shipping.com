...
const translations = {
  en: {
    ...
    route_01_p2: 'Our coverage includes the major loading ports of Ukraine, Türkiye, and Belgium, driving efficient transatlantic and regional trade to strategic discharge hubs across Spain, Türkiye, Germany, and key Western markets.',

    route_02_corridor: 'ECSA > WC/USG/NCSA',
    route_02_title_full: 'East Coast & Gulf',
    route_02_p1: 'With our headquarters in Miami, Florida, Seacape has unparalleled access and knowledge of US East Coast and Gulf ports. This corridor serves as a pivotal gateway for US agricultural exports, steel imports, and the strategic movement of bulk commodities between North America and global markets.',
    route_02_p2: 'Our Miami office provides real-time coordination and hands-on support for all shipments moving through this corridor, ensuring regulatory compliance, port efficiency, and seamless cargo handling.',

    route_03_corridor: 'FEAST > WC',
    route_03_title_full: 'Far East — Japan & China',
    route_03_p1: 'The Asian corridor stands as our most active transpacific route. Through this established trade lane, Seacape manages robust two-way trade flows, seamlessly connecting producers and buyers of steel, concentrates, and other bulk commodities across Japan, China, South Korea, and Southeast Asia with the Americas. This comprehensive network optimizes the supply chain between both regions, ensuring the direct carriage of essential cargoes to the entire American West Coast.',
    route_03_p2: 'Our established relationships with Asian charterers, port agents, and shipowners allow us to execute efficiently in this highly competitive market, providing our clients with reliable coverage and competitive rates.',

    route_04_corridor: 'WC > FEAST',
    route_04_title_full: 'West & Central South America',
    route_04_p1: 'South America represents one of the most dynamic trade corridors for Seacape. With direct office representation through our Santiago, Chile operation and regional presence in Peru and Brazil, we are uniquely positioned to service this market and its evolving demands from both coasts.',
    route_04_p2: 'Our operational coverage across the region is comprehensive, driven by deep-rooted expertise within a flexible and rapidly expanding market. Among our highest-volume fixtures are steel, grains, and concentrates, seamlessly driving cargo flows from the Pacific coast to the Atlantic. We aim to deliver a fully integrated service throughout the region, ensuring maximum coverage to satisfy the unique demands of this market with utmost efficiency.',

    route_05_corridor: 'Cont-Baltic > WC',
    route_05_title_full: 'Continent & Baltic',
    route_05_p1: 'For the Continent/Baltic to West Coast South America (WCSA) route, we primarily focus on prompt cargo opportunities, including fertilizers, grains, and other bulk commodities. This trade offers attractive employment prospects, supported by a steady flow of cargoes and strong seasonal grain programs.',
    route_05_p2: 'During the respective export seasons, the market provides consistent volume and flexibility, making it an interesting and reliable trading area for geared bulk carriers.',
